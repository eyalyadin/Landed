...
export function AddPaymentButton() {
  ...
  useEffect(() => {
    ...
    fetch('/api/tenants')
      .then(r => r.json())
      .then((data: Array<{ id: number; name: string; property_address?: string }>) => {
        setTenants(data.map(t => ({ id: t.id, name: t.name, propertyAddress: t.property_address ?? null })))
      })
      .catch(() => {})
  ...
  function reset() {
    setTenantId(''); setAmount(''); setPaymentType('rent')
      ...
      <DialogContent className="max-w-sm">
        ...
        <form onSubmit={submit} className="space-y-4 py-2">
          ...
          <div className="flex gap-2 pt-1">
            ...
            <Button type="submit" disabled={saving || !tenantId} className="flex-1">
