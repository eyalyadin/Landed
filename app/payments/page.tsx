...
export default function PaymentsPage() {
  ...
  const collectedPayments = samplePayments.filter(
    p => p.status === 'paid' && p.type === 'rent'
  )
  ...
  function getProperty(propertyId: string) {
    return sampleProperties.find(p => p.id === propertyId)
  }
  function getTenant(tenantId: string) {
    return sampleTenants.find(t => t.id === tenantId)
  }
